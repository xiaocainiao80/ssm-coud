	...
	$(document).ready(
			function() {
				function show() {
					...
					$.get("ajax.do?type=down&t=" + timestamp, function(data,
							status) {
						var dl = jQuery.parseJSON(data);
						var cit = $("#downloadlist");
						if (cit.size() > 0) {
							cit.find("tr:not(:first)").remove();
						}
						var dl = jQuery.parseJSON(data);
						for (i = 0; i < dl.length; i++) {
							var status = dl[i].udProcess == '100.0%' ? '下载完成'
									: '正在下载';
							$("#downloadlist").append(
			...
			<div class="banner">
				...
				<div class="bannerCenter">
					<ul>
						...
						<li class="active"><a href="filedownload.jsp">正在下载</a></li>
					</ul>
				</div>
			...
			<div class="content">
				<div class="contentRight" id="contentRight" style="width: 95%">
					...
					<div class="file">
						...
						<table id="downloadlist" rules="rows" frame="below"
							bordercolor="#F2F6FD">
